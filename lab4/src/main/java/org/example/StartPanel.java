...
public class StartPanel extends JPanel {
    ...
    public StartPanel(MainFrame mainFrame) {
        ...
        lab4Button.setBackground(ChartUtils.CREAM);
        ...
        lab3Button.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(ChartUtils.MEDIUM_GRAY, 1),
                BorderFactory.createEmptyBorder(8, 20, 8, 20)));
        lab4Button.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(ChartUtils.MEDIUM_GRAY, 1),
                BorderFactory.createEmptyBorder(8, 20, 8, 20)));
        ...
        lab4Button.addActionListener(e -> mainFrame.showLab4());
