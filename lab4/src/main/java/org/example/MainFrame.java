...
public class MainFrame extends JFrame {
    ...
    private final Lab3Panel lab3Panel;
    private final Lab4Panel lab4Panel;
    ...
    public MainFrame() {
        ...
        lab3Panel = new Lab3Panel();
        lab4Panel = new Lab4Panel();
        ...
        JMenuItem lab3Item = new JMenuItem("ЛР №3: Обработка аудиосигнала");
        lab3Item.addActionListener(e -> showLab3());
        labMenu.add(lab3Item);

        JMenuItem lab4Item = new JMenuItem("ЛР №4: Преобразование текста в речь");
        lab4Item.addActionListener(e -> showLab4());
        labMenu.add(lab4Item);
    ...
    public void showLab3() {
        setContentPane(lab3Panel);
        revalidate();
        repaint();
    }

    public void showLab4() {
        setContentPane(lab4Panel);
        revalidate();
        repaint();
    }
